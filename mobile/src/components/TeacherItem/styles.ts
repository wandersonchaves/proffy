...
const styles = StyleSheet.create({
  ...
  name: { fontFamily: "Archivo_700Bold", color: "#32264d", fontSize: 20 },
  ...
  footer: { backgroundColor: "#fafafc", padding: 24, alignItems: "center", marginTop: 24 },

  price: { fontFamily: "Poppins_400Regular", color: "#6a6180", fontSize: 14 },
  ...
  favorited: { backgroundColor: "#e33d3d"},
